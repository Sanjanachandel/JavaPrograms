...
public class NotificationController {
    ...
    public ResponseEntity<Void> sendOtp(@RequestParam String email, @RequestParam String otp) throws jakarta.mail.MessagingException {
        logger.info("API Call: Send OTP email to {}", email);
