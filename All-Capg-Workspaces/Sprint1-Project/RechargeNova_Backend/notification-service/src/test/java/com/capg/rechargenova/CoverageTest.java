...
class CoverageTest {
    ...
    void testDTOs() {
        ...
        EmailRequest er2 = new EmailRequest("to", "name", "123", "op", 10.0, "30", "tx", "Prepaid");
        ...
        op.setId(1L); op.setName("name"); op.setCircle("Circle");
        assertEquals(1L, op.getId());
        assertEquals("name", op.getName());
        assertEquals("Circle", op.getCircle());

        OperatorDto op2 = new OperatorDto(1L, "name", "circle");
        ...
        p.setId(1L); p.setOperatorId(2L); p.setAmount(10.0); p.setValidity("30"); p.setDescription("desc"); p.setType("Prepaid");
        ...
        PlanDto p2 = new PlanDto(1L, 2L, 10.0, "30", "desc", "Prepaid");
        ...
        RechargeResponse rr2 = new RechargeResponse(1L, 1L, 2L, 3L, "123", BigDecimal.TEN, "S", "Prepaid");
