...
class CoverageTest {
    ...
    void testDTOs() {
        ...
        PlanDto plan2 = new PlanDto(1L, 2L, BigDecimal.TEN, "30", "test");
        ...
        res.setCreatedAt(LocalDateTime.now()); res.setUserId(1L); res.setOperatorId(1L); res.setPlanId(1L); res.setMessage("msg");
        ...
        RechargeResponse res2 = new RechargeResponse(1L, 1L, 1L, 1L, "123", BigDecimal.TEN, "S", LocalDateTime.now(), "M");
        ...
        PaymentRequest pr2 = new PaymentRequest(1L, 1L, BigDecimal.TEN, "P");
    ...
    void testEntity() {
        ...
        Recharge r2 = new Recharge(1L, 1L, 1L, "123", BigDecimal.TEN, "S");
